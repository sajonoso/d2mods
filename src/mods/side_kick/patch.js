var mod_side_kick = {
  LIFE_VALUE: "stat('maxhp'.accr)*2",
  DAMAGE_VALUE: "max(stat('maxdamage'.accr),stat('secondary_maxdamage'.accr))",
  DEFENSE_VALUE: "stat('armorclass'.accr)",

  update_skills_txt: function (mod, targetFiles) {
    var skills_txt_op = {
      "find": "Grim Ward\t150\tbar\tgrim ward",
      "replace": "Grim Ward\t150\tbar\tgrim ward\t\t57\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tarmorclass\t" + 
      this.DEFENSE_VALUE + "\ttohit\tstat('tohit'.accr)\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tmaxhp\t" + this.LIFE_VALUE + 
      "\titem_normaldamage\t" + this.DAMAGE_VALUE + 
      "\thpregen\t164\titem_crushingblow\t25\t\t\t\t\tact5hire1\tsidekick1\t1\tNU\tnatural resistance\t1+min(ulvl/3,19)\t\t\t\t\t\t\t\t\t27\t\t\tnecromancer_golem_cast\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t1\t5\t\tnone\t\t\t\t\t\t\t\t\t\t\t\tSC\tSC\tS1\t\t\t\t\t4\t\t\t\t\t\t\t\t\t1\t\t\t\t\t\t\t\t\t\t\t\t1\t20\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t1\t8\t5\t0\t1\t1\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t1\t\t\t\t\t\t\t\t8\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t384\t3000"
    }
  ...
  update_skilldesc_txt: function(mod, targetFiles) {
    ...
    var skilldesc_txt_op = {
      ...
      "replace": "columns",
      "columns": [
        { "col": 33, "val": "69", "desc": "S1: S2 C1" },
        { "col": 34, "val": SummonTypeName, "desc": "SummonType" },
        { "col": 35, "val": "StrSkill42", "desc": "Life:" },
        { "col": 36, "val": this.LIFE_VALUE + "/256", "desc": "Value/formula" },
  
        { "col": 38, "val": "5", "desc": "S1C1" },
        { "col": 39, "val": "StrSkill21", "desc": "Defense:" },
        { "col": 41, "val": this.DEFENSE_VALUE, "desc": "Value/formula" },
  
        { "col": 43, "val": "5", "desc": "S1C1" },
        { "col": 44, "val": "StrSkill4", "desc": "Damage:" },
        { "col": 46, "val": this.DAMAGE_VALUE, "desc": "Value/formula" },
